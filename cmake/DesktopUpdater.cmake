...
elseif(WIN32)
    ...
    target_include_directories(dunecity PRIVATE "${dunecity_winsparkle_SOURCE_DIR}/include")
    target_link_libraries(dunecity PRIVATE "${dunecity_winsparkle_SOURCE_DIR}/x64/Release/WinSparkle.lib")
    add_custom_command(TARGET dunecity POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different
        "${dunecity_winsparkle_SOURCE_DIR}/x64/Release/WinSparkle.dll" "$<TARGET_FILE_DIR:dunecity>")
    install(FILES "${dunecity_winsparkle_SOURCE_DIR}/x64/Release/WinSparkle.dll" DESTINATION .)
    install(FILES "${dunecity_winsparkle_SOURCE_DIR}/COPYING" DESTINATION licenses RENAME WinSparkle-COPYING)
    install(FILES "${dunecity_winsparkle_SOURCE_DIR}/COPYING.expat" DESTINATION licenses RENAME WinSparkle-COPYING.expat)
else()
